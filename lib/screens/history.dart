    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _isLoading = false;
          _hasError = true;
          _errorMessage = 'Failed to load image for this date.';
        });
      }
    } catch (e) {
      setState(() {
                    ...
                    : _hasError
                        ? Column(
                            children: [
                              Text(
                                _errorMessage,
                                style: TextStyle(color: Colors.red, fontSize: 16, fontFamily: 'Raleway', fontWeight: FontWeight.bold),
                              ...
                              ElevatedButton.icon(
                                ...
                                onPressed: () {
                                  if (_selectedDate != null) fetchData(date: _selectedDate!);
                                },
